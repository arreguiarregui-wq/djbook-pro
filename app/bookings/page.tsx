...
const MOCK_BOOKINGS: Booking[] = [
  { id: '1', created_at: '', user_id: '', venue_name: 'Club Fabrik, Madrid', venue_city: 'Madrid', event_date: '2025-05-10', start_time: '23:00', duration_hours: 5, genre: 'Techno', cachet: 600, currency: 'EUR', travel_included: true, accomodation_included: false, status: 'confirmado', promoter_name: 'Juan Garcia', promoter_email: 'juan@fabrik.es', promoter_phone: null, notes: null, rider_notes: null },
  ...
  { id: '3', created_at: '', user_id: '', venue_name: 'Private event · Seville', venue_city: 'Seville', event_date: '2025-05-17', start_time: '20:00', duration_hours: 7, genre: 'Mixed', cachet: 900, currency: 'EUR', travel_included: true, accomodation_included: true, status: 'confirmado', promoter_name: 'Ana & Carlos', promoter_email: 'anaycarlos2025@gmail.com', promoter_phone: '+34 612 345 678', notes: 'Ceremony 20h, dinner 22h, dance floor 00h-03h', rider_notes: null },
  ...
  { id: '5', created_at: '', user_id: '', venue_name: 'Rooftop Club, Malaga', venue_city: 'Malaga', event_date: '2025-05-24', start_time: '22:00', duration_hours: 5, genre: 'Afro House', cachet: 500, currency: 'EUR', travel_included: false, accomodation_included: false, status: 'pendiente', promoter_name: null, promoter_email: null, promoter_phone: null, notes: null, rider_notes: null },
]
              ...
              <div key={booking.id} className="flex items-center justify-between py-3.5 border-b border-white/[0.06] last:border-0">
                <div className="flex-1">
                  ...
                  <div className="text-xs text-muted mt-1">
                    {new Date(booking.event_date).toLocaleDateString('en-GB', { weekday: 'short', day: 'numeric', month: 'short' })}
      ...
      <div className="bg-surface border border-white/[0.08] rounded-2xl p-7 w-full max-w-lg">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input className="form-input" placeholder="Club, festival, private event..." />
          </div>
          ...
          <div>
            ...
            <textarea className="form-input" placeholder="Rider, special instructions..." rows={2} />
          </div>
        </div>

        <div className="flex gap-3 mt-5">
          <button className="btn-primary flex-1">Save booking</button>
