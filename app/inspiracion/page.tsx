...
const CHARTS = [
  { g: 'house', p: 'Beatport', n: 'Top 100 House', d: 'El chart de house mas seguido del mundo.', t: ['House', 'Tech House'], url: 'https://www.beatport.com/genre/house/5/top-100', upd: 'Semanal' },
  { g: 'house', p: 'Traxsource', n: 'Top 100 House', d: 'Mas underground que Beatport. Referencia para DJs profesionales.', t: ['House', 'Soulful'], url: 'https://www.traxsource.com/genre/2/house', upd: 'Diario' },
  ...
  { g: 'afro', p: 'Traxsource', n: 'Top 100 Afro House', d: 'Exclusivos que no encontraras en Beatport.', t: ['Afro House', 'Afrobeats'], url: 'https://www.traxsource.com/genre/38/afro-house', upd: 'Diario' },
  { g: 'techno', p: 'Beatport', n: 'Top 100 Techno Peak Time', d: 'El techno mas energetico para el horario estelar.', t: ['Techno', 'Industrial'], url: 'https://www.beatport.com/genre/techno/6/top-100', upd: 'Semanal' },
  ...
  { g: 'melodic', p: 'Beatport', n: 'Top 100 Melodic House & Techno', d: 'El genero en mayor auge en Europa ahora mismo.', t: ['Melodic Techno', 'Melodic House'], url: 'https://www.beatport.com/genre/melodic-house-techno/90/top-100', upd: 'Semanal' },
  { g: 'melodic', p: 'Traxsource', n: 'Top 100 Melodic House', d: 'Seleccion refinada de melodic house para DJs.', t: ['Melodic', 'Organic'], url: 'https://www.traxsource.com/genre/96/melodic-house-techno', upd: 'Diario' },
  { g: 'deep', p: 'Beatport', n: 'Top 100 Deep House', d: 'Deep house, garage y sonidos organicos.', t: ['Deep House', 'Garage'], url: 'https://www.beatport.com/genre/deep-house/12/top-100', upd: 'Semanal' },
  { g: 'deep', p: 'Traxsource', n: 'Top 100 Deep House', d: 'Deep house de raiz con influencias de Chicago.', t: ['Deep', 'Chicago'], url: 'https://www.traxsource.com/genre/13/deep-house', upd: 'Diario' },
  ...
  { g: 'dnb', p: 'Juno', n: 'Drum & Bass / Jungle', d: 'La mejor seleccion de D&B en vinilo y digital.', t: ['D&B', 'Jungle', 'Vinyl'], url: 'https://www.juno.co.uk/drum-bass/', upd: 'Continuo' },
  { g: 'ambient', p: 'Beatport', n: 'Top 100 Electronica / Downtempo', d: 'Ambient, IDM y electronica experimental.', t: ['Ambient', 'IDM'], url: 'https://www.beatport.com/genre/electronica/3/top-100', upd: 'Semanal' },
  ...
  { g: 'trance', p: 'Beatport', n: 'Top 100 Progressive House', d: 'Progressive house con raices en el trance.', t: ['Progressive', 'Melodic'], url: 'https://www.beatport.com/genre/progressive-house/15/top-100', upd: 'Semanal' },
  ...
  { g: 'disco', p: 'Juno', n: 'Disco & Funk', d: 'La mayor seleccion de disco y funk en vinilo.', t: ['Disco', 'Vinyl'], url: 'https://www.juno.co.uk/disco/', upd: 'Continuo' },
]
...
const QUICK_PROMPTS = [
  'Top 10 tracks de afro house que todo DJ deberia conocer',
  'Mejores tracks de melodic techno para set nocturno en Berlin',
  ...
  'Que sonidos de house estan dominando en Europa ahora',
]
...
export default function InspirationPage() {
  ...
  return (
    <AppLayout>
      <div>
        <h1 className="page-title">Inspiracion musical</h1>
        <p className="page-sub">Charts en tiempo real, DJs referentes y busqueda con IA — 9 generos</p>
        ...
        {activeTab === 'ia' && (
          <div>
            <div className="card mb-4">
              <div className="text-sm font-medium text-white mb-3">Pregunta sobre musica</div>
